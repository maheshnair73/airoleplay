...
export const ModuleAccess = createEntity('module_configuration');
...
export const ContentMaterial = createEntity('roleplay_content_materials');
export const SessionContentLink = createEntity('roleplay_session_content_links');
export const ContentUsageAnalytics = createEntity('content_usage_analytics');
